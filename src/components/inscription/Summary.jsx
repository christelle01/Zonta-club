        ...
        <Stack spacing={2}>
          ...
          <Stack>
            ...
            <LineText
              ...
              value={values.travel.arrivalDate ?  new Date(values.travel.arrivalDate).toLocaleDateString() : '' }
            />
            <LineText
              title="DATE DE RETOUR DE LOMÉ"
              value={values.travel.returnDate ?  new Date(values.travel.returnDate).toLocaleDateString() : '' }
            />
            <LineText
          ...
          <Stack>
            ...
            <LineText
              ...
              value={values.hosting.entryDate ?  new Date(values.hosting.entryDate).toLocaleDateString() : '' }
            />
            <LineText
              title="DATE DE SORTIE DE L'HOTEL"
               value={values.hosting.checkOut ?  new Date(values.hosting.checkOut).toLocaleDateString() : '' }
